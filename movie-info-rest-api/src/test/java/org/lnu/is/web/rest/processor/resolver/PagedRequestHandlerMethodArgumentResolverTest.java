...
public class PagedRequestHandlerMethodArgumentResolverTest {
	...
	public void testResolveArgument() throws Exception {
		...
		parameterMap.put("title", new String[] { name });

		Map<String, String> requestParameters = new HashMap<>();
		requestParameters.put("id", id);
		requestParameters.put("title", name);
		...
		OrderBy order1 = new OrderBy("title", OrderByType.ASC);
		OrderBy order2 = new OrderBy("year", OrderByType.DESC);
		List<OrderBy> orders = Arrays.asList(order1, order2);
		PagedRequest<FilmResource> expected = new PagedRequest<FilmResource>(resource,
	...
	public void testResolveArgumentWithCapitalLetter() throws Exception {
		...
		Map<String, Object> parameters = new HashMap();
		parameters.put("id", id);
		parameters.put("title", Arrays.asList(name));
